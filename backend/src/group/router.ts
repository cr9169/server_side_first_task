...
import { getGroupByIDC, deleteGroupByIDRegularC, deleteGroupByIDC, createGroupC, updateGroupByIDC, getAllGroupsAndPeopleInGroupC, getAllGroupsC, updateGroupObjectByIDC } from "./controller";
