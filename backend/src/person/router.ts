...
import {
  getPersonByIDC, deletePersonByIDC, createPersonC, updatePersonByIDC,
  getPersonInGroupByNameC, getAllGroupsOfPersonC, getPopulatedPeople, getAllPeopleC,
  updatePersonObjectByIDC, simplyCreatePersonC, deletePersonByIDRegularC,
} from './controller';
